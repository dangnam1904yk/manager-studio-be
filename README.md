...
### About project
* Create private/public key using git bash
```
openssl genrsa -out private_key_raw.pem 2048
openssl pkcs8 -topk8 -inform PEM -outform PEM -nocrypt -in private_key_raw.pem -out private_key.pem
